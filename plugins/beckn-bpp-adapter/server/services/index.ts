...
import trackCommerceWorkflowService from './track/commerce-workflow-service';
import trackAppointmentWorkflowService from './track/appointment-workflow-service';
...
export default {
  ...
  trackCommerceWorkflowService,
  trackAppointmentWorkflowService,
  trackService,
