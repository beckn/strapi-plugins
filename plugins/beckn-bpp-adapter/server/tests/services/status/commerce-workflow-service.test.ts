    ...
    it('should return an array of order details when given a valid order ID and context', async () => {
        ...
        expect(strapi.entityService.findMany).toHaveBeenCalledWith(
          "api::order-fulfillment.order-fulfillment",
          {
            ...
            populate: {"order_id":{"filters":{"domain":{"$eq":"domain"}},"populate":{"items":{"populate":{"cat_attr_tag_relations":{"filters":{"taxanomy":{"$in":["TAG","CATEGORY"]}}},"image":{},"item_fulfillment_id":{"populate":{"fulfilment_id":{}}},"item_meta_id":{"populate":{"fulfilment_id":{},"location_id":{}}},"sc_retail_product":{"populate":{"price_bareakup_ids":{},"product_cancel":{"populate":{"cancel_term_id":{}}}}},"provider":{"populate":{"logo":{},"location_id":{},"category_ids":{},"fulfillments":{},"payment_methods":{}}},"service":{}}},"order_address":{}}},"fulfilment_id":{},"customer_id":{},"agent_id":{},"order_fulfillment_location_id":{}}
          }
        );
