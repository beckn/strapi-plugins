...
describe('default', () => {
    ...
    it('should have \'strapi\' argument with \'plugin\' method', () => {
      ...
      commerceWorkflowService({ strapi: strapi as any }).index(obj);
    ...
    it('should return an error when the \'message\' property is not a string', () => {
      ...
      expect(() => commerceWorkflowService({ strapi: strapi as any }).index(obj)).toThrow('The \'message\' property must be a string');
    });
